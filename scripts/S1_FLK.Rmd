...
```{r, echo=FALSE, fig.cap="Comparison of allele frequencies in both populations for all tested SNPs. SNPs considered as significant under FLK are highlighted in red."}
flkResults %>%
  mutate(Sig = FDR < 0.05) %>%
