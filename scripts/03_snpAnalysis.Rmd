...
```{r reducedPCA, echo = FALSE, fig.cap="Principal Component Analysis after removal of SNPs showing evidence of structure within the 2012 population.", fig.height=5, fig.width=7}
reducedPCA$x %>%
  as.data.frame() %>%
  rownames_to_column("sampleID") %>%
  as_data_frame() %>%
