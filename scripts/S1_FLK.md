...
The set of 17,938 SNPs previously obtained for testing after all filtering steps were then tested using the FLK model.
...
A total of 6 SNPs retained significance after the Bonferroni adjustment with a total of 42 being considered in the larger set of SNPs with an FDR of 0.05.
