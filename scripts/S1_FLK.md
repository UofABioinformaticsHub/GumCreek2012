...
![Neighbour-joining Tree for all 3 populations.](S1_FLK_files/figure-html/njTree-1.png)
...
The set of 18,393 SNPs previously obtained for testing after all filtering steps were then tested using the FLK model.
(1943 SNPs previously identified as showing a regional effect in the 2012 population were removed from FLK analysis.)
...
![Comparison of allele frequencies in both populations for all tested SNPs. SNPs considered as significant under FLK to an FDR of 0.05 are highlighted in red.](S1_FLK_files/figure-html/plotFlkSnps-1.png)
